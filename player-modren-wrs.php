...
<head>
    ...
    <title>SportsMagazine Player Modren WRS</title>
    ...
    <div class="sportsmagazine-main-wrapper">
        ...
        <div class="sportsmagazine-subheader">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Player Modren W/R/Sidebar</h1>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <div class="sportsmagazine-player sportsmagazine-classic-player">
                                <ul class="row">
                                        ...
                                        <figure>
                                            ...
                                            <figcaption>
                                                <div class="sportsmagazine-classic-player-info">
                                                    <h4><a href="player-detail.html">Micheal Darren</a></h4>
                                                    <span>Forword</span>
                                                    <ul class="classic-player-option">
                                                        <li><i class="fa fa-calendar-o"></i> <time datetime="2008-02-14 20:00">August 21,1988</time></li>
                                                        <li><i class="fa fa-futbol-o"></i> <span>83 Goals</span></li>
                                                    </ul>
                                                    <p>Lorem ipsum dolor sit amet, contur ad Vestibulum a nunc dui.</p>
                                    ...
                                    <li class="col-md-6">
                                        <figure>
                                            <a href="player-detail.html"><img src="extra-images/team-grid-img2.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="sportsmagazine-classic-player-info">
                                                    <h4><a href="player-detail.html">Chris Marlon</a></h4>
                                                    <span>Defensive</span>
                                                    <ul class="classic-player-option">
                                                        <li><i class="fa fa-calendar-o"></i> <time datetime="2008-02-14 20:00">August 21,1988</time></li>
                                                        <li><i class="fa fa-futbol-o"></i> <span>83 Goals</span></li>
                                    ...
                                    <li class="col-md-6">
                                        <figure>
                                            <a href="player-detail.html"><img src="extra-images/team-grid-img3.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="sportsmagazine-classic-player-info">
                                                    <h4><a href="player-detail.html">Sarena Jordan</a></h4>
                                                    <span>Attacker</span>
                                                    <ul class="classic-player-option">
                                                        <li><i class="fa fa-calendar-o"></i> <time datetime="2008-02-14 20:00">August 21,1988</time></li>
                                                        <li><i class="fa fa-futbol-o"></i> <span>83 Goals</span></li>
                                    ...
                                    <li class="col-md-6">
                                        <figure>
                                            <a href="player-detail.html"><img src="extra-images/team-grid-img4.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="sportsmagazine-classic-player-info">
                                                    <h4><a href="player-detail.html">Micheal Darren</a></h4>
                                                    <span>Forword</span>
                                    ...
                                    <li class="col-md-6">
                                        <figure>
                                            <a href="player-detail.html"><img src="extra-images/team-grid-img5.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="sportsmagazine-classic-player-info">
                                                    <h4><a href="player-detail.html">Chris Marlon</a></h4>
                                                    <span>Defensive</span>
                                    ...
                                    <li class="col-md-6">
                                        <figure>
                                            <a href="player-detail.html"><img src="extra-images/team-grid-img6.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="sportsmagazine-classic-player-info">
                                                    <h4><a href="player-detail.html">Sarena Jordan</a></h4>
                                                    <span>Attacker</span>
