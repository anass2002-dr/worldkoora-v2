...
<head>
    ...
    <title>SportsMagazine Player List</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="sportsmagazine-player sportsmagazine-player-list">
                                <ul class="row">
                                    <li class="col-md-6">
                                        <figure><a href="player-detail.php"><img src="extra-images/player-list-img1.jpg" alt=""><i class="fa fa-link"></i></a></figure>
                                        <div class="sportsmagazine-player-list-text">
                                            <a href="player-detail.php" class="sportsmagazine-forword-btn">Forword</a>
                                            <h5><a href="player-detail.php">Darren Layfield</a></h5>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="player-detail.php"><img src="extra-images/player-list-img2.jpg" alt=""><i class="fa fa-link"></i></a></figure>
                                        <div class="sportsmagazine-player-list-text">
                                            <a href="player-detail.php" class="sportsmagazine-forword-btn">Forword</a>
                                            <h5><a href="player-detail.php">Sarena jullie</a></h5>
                                            <p>Lorem ipsum dolor amet, codnse abitur lacinia diam tus temposr iquam et arcu libero. </p>
                                            <ul class="sportsmagazine-player-social">
                                                <li><a href="https://www.facebook.com/" class="icon-facebook2"></a></li>
                                                <li><a href="https://plus.google.com/" class="icon-google-plus2"></a></li>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="player-detail.php"><img src="extra-images/player-list-img3.jpg" alt=""><i class="fa fa-link"></i></a></figure>
                                        <div class="sportsmagazine-player-list-text">
                                            <a href="player-detail.php" class="sportsmagazine-forword-btn">Forword</a>
                                            <h5><a href="player-detail.php">Chris Morris</a></h5>
                                            <p>Lorem ipsum dolor amet, codnse abitur lacinia diam tus temposr iquam et arcu libero. </p>
                                            <ul class="sportsmagazine-player-social">
                                                <li><a href="https://www.facebook.com/" class="icon-facebook2"></a></li>
                                                <li><a href="https://plus.google.com/" class="icon-google-plus2"></a></li>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="player-detail.php"><img src="extra-images/player-list-img4.jpg" alt=""><i class="fa fa-link"></i></a></figure>
                                        <div class="sportsmagazine-player-list-text">
                                            <a href="player-detail.php" class="sportsmagazine-forword-btn">Forword</a>
                                            <h5><a href="player-detail.php">Sophie james</a></h5>
                                            <p>Lorem ipsum dolor amet, codnse abitur lacinia diam tus temposr iquam et arcu libero. </p>
                                            <ul class="sportsmagazine-player-social">
                                                <li><a href="https://www.facebook.com/" class="icon-facebook2"></a></li>
                                                <li><a href="https://plus.google.com/" class="icon-google-plus2"></a></li>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="player-detail.php"><img src="extra-images/player-list-img5.jpg" alt=""><i class="fa fa-link"></i></a></figure>
                                        <div class="sportsmagazine-player-list-text">
                                            <a href="player-detail.php" class="sportsmagazine-forword-btn">Forword</a>
                                            <h5><a href="player-detail.php">Brad Haddin</a></h5>
                                            <p>Lorem ipsum dolor amet, codnse abitur lacinia diam tus temposr iquam et arcu libero. </p>
                                            <ul class="sportsmagazine-player-social">
                                                <li><a href="https://www.facebook.com/" class="icon-facebook2"></a></li>
                                                <li><a href="https://plus.google.com/" class="icon-google-plus2"></a></li>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="player-detail.php"><img src="extra-images/player-list-img6.jpg" alt=""><i class="fa fa-link"></i></a></figure>
                                        <div class="sportsmagazine-player-list-text">
                                            <a href="player-detail.php" class="sportsmagazine-forword-btn">Forword</a>
                                            <h5><a href="player-detail.php">Darren Layfield</a></h5>
                                            <p>Lorem ipsum dolor amet, codnse abitur lacinia diam tus temposr iquam et arcu libero. </p>
