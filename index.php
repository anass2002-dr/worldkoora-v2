...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="sportsmagazine-banner-wrap">
                                        ...
                                        <a href="404.php" class="sportsmagazine-banner-btn">Read More <span></span></a>
                                    </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="sportsmagazine-match-result">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <h4><a href="fixture-detail.php">Sharks Club</a></h4>
                                        <span>03 Mark Baily (21)</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="sportsmagazine-blog sportsmagazine-blog-grid">
                                <ul class="row">
                                    <li class="col-md-6">
                                        <figure>
                                            <a href="blog-detail.php"><img src="extra-images/latest-blog-1.jpg" alt=""></a>
                                            <figcaption>
                                                <span><small>متميز</small></span>
                                                <a href="blog-detail.php" class="sportsmagazine-link-btn"><i class="fa fa-link"></i></a>
                                            </figcaption>
                                        </figure>
                                        <section>
                                            <h2><a href="blog-detail.php">The new eco friendly stadium won a Leafy Award in 2016</a></h2>
                                        ...
                                        <div class="sportsmagazine-blog-grid-options">
                                            <a href="blog-detail.php" class="sportsmagazine-blog-grid-thumb"><img src="extra-images/blog-thumb-1.jpg" alt=""> Julia Martyn</a>
                                            <ul>
                                                <li><i class="fa fa-thumbs-o-up"></i> <a href="404.php">320</a></li>
                                                <li><i class="fa fa-eye"></i> <a href="404.php">840</a></li>
                                                <li><i class="fa fa-share-alt"></i> <a href="404.php">89</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="col-md-6 sportsmagazine-the-league">
                                        <figure>
                                            <a href="blog-detail.php"><img src="extra-images/latest-blog-2.jpg" alt=""></a>
                                            <figcaption>
                                                <span><small>الدوري</small></span>
                                                <a href="blog-detail.php" class="sportsmagazine-link-btn"><i class="fa fa-link"></i></a>
                                            </figcaption>
                                        </figure>
                                        <section>
                                            <h2><a href="blog-detail.php">Michael Bryan was chosen as best player with 45 points</a></h2>
                                            <p>Lorem ipsum dolor sit amet, consecttur adipis elit. Vestibulum a nunc dui. Curabitr dignissi luctus nisi id euismod. feugiat eros. Pellentesque tempus tortor.</p>
                                        </section>
                                        <div class="sportsmagazine-blog-grid-options">
                                            <a href="blog-detail.php" class="sportsmagazine-blog-grid-thumb"><img src="extra-images/blog-thumb-1.jpg" alt=""> Julia Martyn</a>
                                    ...
                                    <div class="sportsmagazine-blog sportsmagazine-blog-grid">
                                        <ul class="row">
                                            <li class="col-md-12 sportsmagazine-the-team">
                                                <figure>
                                                    <a href="blog-detail.php"><img src="extra-images/latest-blog-3.jpg" alt=""></a>
                                                    <figcaption>
                                                        <span><small>الفريق</small></span>
                                                        <a href="blog-detail.php" class="sportsmagazine-link-btn"><i class="fa fa-link"></i></a>
                                                    </figcaption>
                                                </figure>
                                                <section>
                                                    <h2><a href="blog-detail.php">The vicotory againts The Shark brings us close to the Final</a></h2>
                                                    <p>Lorem ipsum dolor sit amet, consecttur adipis elit. Vestibulum a nunc dui. Curabitr dignissi luctus nisi id euismod. feugiat eros. Pellentesque tempus tortor.</p>
                                                </section>
                                                <div class="sportsmagazine-blog-grid-options">
                                                    <a href="blog-detail.php" class="sportsmagazine-blog-grid-thumb"><img src="extra-images/blog-thumb-1.jpg" alt=""> Julia Martyn</a>
                                        ...
                                        <ul class="row">
                                            <li class="col-md-12">
                                                <div class="sportsmagazine-blog-list-wrap">
                                                    <span>الفريق</span>
                                                    <h6><a href="blog-detail.php">The victry againts The Shark bring us closer to the Final</a></h6>
                                            ...
                                            <li class="col-md-12 playoffs">
                                                <div class="sportsmagazine-blog-list-wrap">
                                                    <span>التصفيات</span>
                                                    <h6><a href="blog-detail.php">The new eco friendly stadium won a Leafy Award in 2016</a></h6>
                                                    <time datetime="2008-02-14 20:00">August 23rd, 2017</time>
                                                    <p>Lorem ipsum dolor sit amet, consecttur adipis elit. Vestibulum a nunc dui.</p>
                                                </div>
                                            </li>
                                ...
                                <div class="sportsmagazine-player-slider-image">
                                    <div class="sportsmagazine-player-image-layer">
                                        ...
                                        <div class="sportsmagazine-player-slider-caption">
                                            <span>97</span>
                                            <section>
                                                <h6><a href="fixture-detail.php">Micheal Darren</a></h6>
                                                <small>Forword</small>
                                            </section>
                                        </div>
                                    </div>
                                    <div class="sportsmagazine-player-image-layer">
                                        ...
                                        <div class="sportsmagazine-player-slider-caption">
                                            <span>38</span>
                                            <section>
                                                <h6><a href="fixture-detail.php">sarena Jordan</a></h6>
                                    ...
                                    <div class="sportsmagazine-player-image-layer">
                                        ...
                                        <div class="sportsmagazine-player-slider-caption">
                                            <span>10</span>
                                            <section>
                                                <h6><a href="fixture-detail.php">Chris Marlon</a></h6>
                                                <small>Forword</small>
                                            </section>
                                        </div>
                                    </div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="popular_news_text">
                                            <small>الفريق</small>
                                            <a href="blog-detail.php">Basketball Stadium will a max capacity for 5000 fans</a>
                                    ...
                                    <li class="widget-theleague">
                                        ...
                                        <div class="popular_news_text">
                                            <small>الدوري</small>
                                            <a href="blog-detail.php">Take look to the brand new helmets for next season</a>
                                            <time datetime="2008-02-14 20:00">December 21, 2017</time>
                                        </div>
                                    </li>
                                    <li>
                            ...
                            <div class="widget widget_next_match">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <h6><a href="fixture-detail.php">Basketball</a></h6>
                                    ...
                                    <li>
                                        ...
                                        <h6><a href="fixture-detail.php">Combine</a></h6>
                                ...
                                <a href="fixture.php" class="widget_match_btn">Buy Ticket Now</a>
                            </div>
                            <!--// Widget Next Match \\-->
    ...
    <!-- <script>
        ...
        const options = {
            method: 'GET',
            headers: {
                'X-RapidAPI-Key': '6507df62fcmshbc5070f4e751940p160e84jsn39337b0da62f',
                'X-RapidAPI-Host': 'livescore6.p.rapidapi.com'
            }
        };

        try {
            async function fetchMovies(url1, options1) {
