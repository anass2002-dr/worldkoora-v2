...
<head>
    ...
    <title>SportsMagazine Player Grid WRS</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="sportsmagazine-player sportsmagazine-player-grid">
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img1.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img2.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img3.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img4.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                    ...
                                    <li class="col-md-4">
                                        ...
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">John Sam</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img5.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">Sophie Williams</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img6.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">shaun marsh</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img7.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">alastair strauss</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img8.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">Micheal Jordan</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
                                    ...
                                    <li class="col-md-4">
                                        ...
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">Joe Trott</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="shop-detail.html"><img src="extra-images/player-grid-img9.jpg" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">Steve Micheal</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
