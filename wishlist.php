...
<head>
    ...
    <title>SportsMagazine Your Wishlist</title>
                            ...
                            <div class="sportsmagazine-wishlist">
                                ...
                                <div class="sportsmagazine-wishlist-graph">
                                    ...
                                    <ul class="wishlist-graph">
                                        ...
                                        <li>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ac malesuada ante. Curabitur lacinia diam.</p>
                                        </li>
                                        <li>$28.00</li>
                                        <li>In Stock</li>
                                        <li><a class="remove-line" href="#"><i class="fa fa-times"></i></a></li>
                                    </ul>
                                    <ul class="wishlist-graph">
                                        <li>
